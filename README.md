...
You must first register for a valid Microsoft Azure account. 

You may create the Azure account with an existing Microsoft account as well. After account creation, you should have a valid subscription option / method
